/*
 * Code is from http://math.hws.edu/javanotes/c3/s8.html 
 */
...
public class BirthdayProblem {
   ...
   public static void main(String[] args) {
        ...
        int i,b_count;       // The number of people who have been checked.
        ...
        System.out.println();
        System.out.println("A average tries until duplicate birthday is: " + (float)b_count/i);
